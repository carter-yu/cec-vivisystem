...
| Parser                 | Turns natural language (Cantonese/English) into structured intent | **Done (Phase 1 + 3 + 9 aliases + 10 titles + 11 聽朝 + 12 list phrases + 14 period windows + 15 important dates)** |
